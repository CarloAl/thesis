...
JoinNode.extend({
    instance: {
        ...
        notBlockedContext: function (leftContext, propagate,runTime,ruleBetaNodes) {
            this.__addToLeftMemory(leftContext);
            propagate && this.__propagate("assert", this.__cloneContext(leftContext),runTime,ruleBetaNodes);
        },
        ...
        blockFromAssertRight: function (leftContext, rightContext,runTime,ruleBetaNodes) {
            this.blockedContext(leftContext, rightContext, true,runTime,ruleBetaNodes);
        },

        blockFromAssertLeft: function (leftContext, rightContext,runTime,ruleBetaNodes) {
            this.blockedContext(leftContext, rightContext, false,runTime,ruleBetaNodes);
        },
        ...
        assertLeft: function (context,runTime,ruleBetaNodes) {
            ...
            while (++i < l) {
                if (thisConstraint.isMatch(context, rc = values[i].data)) {
                    this.blockFromAssertLeft(context, rc,runTime,ruleBetaNodes);
                    context = null;
                    i = l;
                }
            }
        ...
        assertRight: function (context,runTime,ruleBetaNodes) {
            ...
            while (++i < l) {
                ...
                if (thisConstraint.isMatch(leftContext, context)) {
                    this.blockFromAssertRight(leftContext, context,runTime,ruleBetaNodes);
                }
            }
        },
